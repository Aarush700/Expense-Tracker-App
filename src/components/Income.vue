...
// Filter transactions to get only income
const incomeTransactions = ref(savedTransactions.filter(transaction => transaction.transactionType === "income"));
...
const filteredTransactions = computed(() => {
  return filterTransactions(incomeTransactions.value);
});
...
<style scoped>
/* Add custom styling for the table and search input */
.income-container {
